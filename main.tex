...
%color palette (you can see the colors in the color_palette.png)
\definecolor{tblue}{HTML}{4B90E2}
\definecolor{tyellow}{HTML}{F8E71C}
\definecolor{torange}{HTML}{F5A622}
\definecolor{tred}{HTML}{D0011C}
\definecolor{tviolet}{HTML}{8F13FE}
\definecolor{tpurple}{HTML}{BD11E0}
\definecolor{tgreen}{HTML}{407505}
\definecolor{tlime}{HTML}{B8E986}
